...
inline ::fixbug::User* userList::mutable_users(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.userList.users)
  return _impl_.users_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >*
userList::mutable_users() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.userList.users)
  return &_impl_.users_;
}
inline const ::fixbug::User& userList::_internal_users(int index) const {
  return _impl_.users_.Get(index);
}
inline const ::fixbug::User& userList::users(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.userList.users)
  return _internal_users(index);
}
inline ::fixbug::User* userList::_internal_add_users() {
  return _impl_.users_.Add();
}
inline ::fixbug::User* userList::add_users() {
  ::fixbug::User* _add = _internal_add_users();
  // @@protoc_insertion_point(field_add:fixbug.userList.users)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >&
userList::users() const {
  // @@protoc_insertion_point(field_list:fixbug.userList.users)
  return _impl_.users_;
}
